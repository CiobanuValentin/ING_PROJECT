...
public class URLHelperTest {
    ...
    void url_should_have_1_path_parameter(){
        String value = "https://github.com/ing";
        int size = URLHelper.getPathParametersFromUrl(value).size();
        assert size == 1;
    }
    ...
    void url_should_have_2_path_parameters(){
        String value = "https://storage.googleapis.com/ing/book.pdf";
        int size = URLHelper.getPathParametersFromUrl(value).size();
        assert size == 2;
    }
    ...
    void url_path_contains_a_file_called_book_pdf(){
        String value = "https://storage.googleapis.com/ing/book.PDF?GoogleAccessId=dev-assets@ing-dev-36262.iam.gserviceaccount.com&Expires=1604102049&Signature=ghgBRtyu5hcZllFjFDUJEdNmA";
